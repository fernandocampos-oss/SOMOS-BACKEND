...
//    List<RequerimientoUsuario> listarRequerimientosRechazadoPorUsuario(@Param("idUsuario") Number idUsuario);
    ...
    @Transactional
    @Modifying
    @Query(value = "INSERT INTO requerimiento_usuario(id_requerimiento, id_usuario, id_estado_requerimiento, cod_red, cod_unidad_solicitante, fecha_creacion, es_jefe, anio_registro) VALUES (:idRequerimiento, :idUsuario, :idEstadoRequerimiento, :codRed, :codUnidadOrganizacion, :fechaCreacion, :esJefe, :anioRegistro)", nativeQuery = true)
    Integer registrarRequerimientoUsuario(@Param("idRequerimiento") Integer idRequerimiento,
                                          ...
                                          @Param("anioRegistro") Number anioRegistro);
...
//
    ...
    List<RequerimientoUsuario> getAllRequerimientoUsuarioPorAnio(@Param("anioRegistro") Number anioRegistro);

    @Query("SELECT tvm FROM TipoValorMeta tvm ORDER BY tvm.descripcion ASC")
