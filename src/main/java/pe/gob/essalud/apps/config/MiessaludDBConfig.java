...
@EnableJpaRepositories(
        ...
        basePackages = "pe.gob.essalud.apps.repository.miessalud"
)
public class MiessaludDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory1(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("pe.gob.essalud.apps.model.miessalud")
    ...
    public SqlSessionFactoryBean sqlSessionFactory(@Qualifier("dataSource1") DataSource dataSource) throws Exception {
        ...
        sessionFactoryBean.setTypeAliasesPackage("pe.gob.essalud.apps");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        configurer.setBasePackage("pe.gob.essalud.apps.repository.miessalud.sqlmap");
        return configurer;
    }
